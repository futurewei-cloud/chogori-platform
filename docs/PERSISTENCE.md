...
- Seal: The client will send the seal request to the Plog Servers with a sealed offest. If this offest is inconsistent with the current offset the Plog Server holds, it will seal this Plog with the smaller offest. Once a Plog is Sealed, the client will not be allowed to make any modifications. 
