#include "MapIndexer.h"

namespace k2 {

void MapIndexer::insert(String key, String value, uint64_t version) {
...
VersionedTreeNode* MapIndexer::find(const String& key, uint64_t version) {
...
void MapIndexer::trim(const String& key, uint64_t version) {
