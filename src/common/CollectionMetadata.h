...
//  WARNING: if we change it to add polymorphism we need to change
//  CollectionMetadataPtr to use shared_ptr instead of lw_shared_ptr
//
...
public:
    ...
    CollectionMetadata(CollectionId collectionId, ModuleId moduleId,
                       Properties properties)
        : collectionId(collectionId), properties(std::move(properties)),
          moduleId(moduleId)
    {
    }
