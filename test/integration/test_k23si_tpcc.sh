...
./build/src/k2/cmd/tpcc/tpcc_client -c1 --tcp_remotes ${EPS} --cpo ${CPO} --tso_endpoint ${TSO} --data_load true --num_warehouses 1 --prometheus_port 63100 --enable_tx_checksum true --reactor-backend epoll --memory=512M --partition_request_timeout=30s --num_concurrent_txns=2
